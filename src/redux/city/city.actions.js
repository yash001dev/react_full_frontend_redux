...
export const fetchCollectionsStart=()=>({
    type:'CITY_FETCH_COLLECTIONS_START',
});

export const fetchCollectionsSuccess=collectionsMap=>({
    type:'CITY_FETCH_COLLECTIONS_SUCCESS',
    payload:collectionsMap
});

export const fetchCollectionFailure=errorMessage=>({
    type:'CITY_FETCH_COLLECTIONS_FAILURE',
    payload:errorMessage
});

export const updateData=item=>({
    type:'CITY_COLLECTION_UPDATE',
    payload:item
});

export const deleteData=item=>({
    type:'CITY_COLLECTION_DELETE',
    payload:item
});

//Update Collection
export const updateCollectionsStart=()=>({
    type:'CITY_UPDATE_COLLECTIONS_START',
});
...
export const fetchCollectionsStartAsync=()=>{
    return dispatch=>{
        ...
        axios.get('http://localhost:3001/api/city/get')
        .then((response)=>{
...
export const updateCollectionsStartAsync=(item)=>{
    ...
    return dispatch=>{
        dispatch(updateCollectionsStart());
        axios.put('http://localhost:3001/api/city/update',item)
        .then((res)=>{
