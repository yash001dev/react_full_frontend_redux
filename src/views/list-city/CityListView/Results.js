...
import {fetchCollectionsStartAsync,updateData,deleteData} from '../../../redux/city/city.actions';
            ...
            <TableBody>
              {chemistData.slice(0, limit).map((data,index) => (
                <TableRow
                  ...
                  key={index}
                  selected={selectedCustomerIds.indexOf(data.city_id) !== -1}
                >
...
const mapStateToProps=(state)=>({
  chemistData:state.city.collections
});
