...
import {fetchCollectionsStartAsync,updateData,deleteData} from '../../../redux/worktype/worktype.actions';
            ...
            <TableBody>
              {chemistData.slice(0, limit).map((data,index) => (
                <TableRow
                  ...
                  key={index}
                  selected={selectedCustomerIds.indexOf(data.worktype_id) !== -1}
                >
...
const mapStateToProps=(state)=>({
  chemistData:state.worktype.collections
});
